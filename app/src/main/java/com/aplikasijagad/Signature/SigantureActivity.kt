package com.aplikasijagad.Signature
...
import kotlinx.android.synthetic.main.activity_siganture.*
import java.io.*
import kotlin.jvm.Throws

class SigantureActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_siganture)
    ...
    companion object {
        ...
        fun verifyStoragePermissions(activity: SigantureActivity?) {
